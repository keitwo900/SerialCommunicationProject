...
namespace SerialCommunicationTest
{
	public partial class Form1 : Form
	{
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void button_RxMsgClear_Click(object sender, EventArgs e)
		{
			textBox_RxMsg.Clear();
		}
		...
		private void button_Tx_Click(object sender, EventArgs e)
		{
			...
			{
				serialPort1.Write(textBox_TxMsg.Text + "\r\n");
			}
			else
			{
		...
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void button_TxMsgClear_Click(object sender, EventArgs e)
		{
			textBox_TxMsg.Clear();
		}
	}
